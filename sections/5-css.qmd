...
[CSS rules can conflict -- the more specific rule "wins"]{.slide-title}

<hr>

It is common to have more than one CSS rule that points to the same element. As you build more complex stylesheets, determining which CSS rule "wins out" can get complicated. At a very basic level, the more specific CSS "wins". 

In the context of today's talk, class selectors are more specific than element selectors and will take precedence. 
