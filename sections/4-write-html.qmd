...
[markdown lets us "write" HTML without knowing HTML]{.slide-title}
...
::: {.body-text .center-text}
Check out the following HTML by opening the [`practice-markdown.qmd` file](https://github.com/samanthacsik/cute-cats-dogs/blob/main/practice-files/practice-markdown.qmd) in RStudio
:::
...
::: {.body-text .center-text}
Click **Render** to render your `.qmd` file as HTML -- it should open in RStudio's Viewer pane and generate a `practice-markdown.html` file
:::
